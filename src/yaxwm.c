...
void clientborder(Client *c, int focused)
{
	...
	vc = xcb_change_window_attributes_checked(con, c->win, XCB_CW_BORDER_PIXMAP, &pmap);
	iferr(0, "unable to set window BORDER_PIXMAP attribute", xcb_request_check(con, vc));
