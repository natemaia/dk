...
void updatenumws(int needed)
{
	...
	FOR_EACH(m, monitors)
		n++;
	/* if (primary && primary != monitors) { */
	/* 	FIND_PREV(m, primary, monitors); */
	/* 	if (m) */
	/* 		m->next = primary->next; */
	/* 	primary->next = monitors; */
	/* 	monitors = primary; */
	/* } */
	if (n > 999)
